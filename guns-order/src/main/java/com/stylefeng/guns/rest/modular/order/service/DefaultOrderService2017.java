...
public class DefaultOrderService2017 implements OrderServiceAPI {
    ...
    public boolean isNotSoldSeats(String fieldId, String seats) {
        ...
        List<MoocOrderT> list = moocOrder2017TMapper.selectList(entityWrapper);
    ...
    public OrderVO  saveOrderInfo(Integer fieldId, String soldSeats, String seatsName, Integer userId) {
        ...
        Integer integer = moocOrder2017TMapper.insert(moocOrderT);
        if(integer > 0) {
            //返回查询结果
    ...
    public String getSoldSeatsByFieldId(Integer fieldId) {
        ...
        if(fieldId == null) {
            ...
            String result = moocOrder2017TMapper.getSoldSeatsByFieldId(fieldId);
            return result;
        }
    }
