...
@Slf4j
@Component
@Service(interfaceClass = OrderServiceAPI.class, group = "group2018")
public class DefaultOrderService2018 implements OrderServiceAPI {
    ...
    public boolean isNotSoldSeats(String fieldId, String seats) {
        ...
        List<MoocOrderT> list = moocOrder2018TMapper.selectList(entityWrapper);
    ...
    public OrderVO  saveOrderInfo(Integer fieldId, String soldSeats, String seatsName, Integer userId) {
        ...
        Integer integer = moocOrder2018TMapper.insert(moocOrderT);
        if(integer > 0) {
            //返回查询结果
    ...
    public String getSoldSeatsByFieldId(Integer fieldId) {
        ...
        if(fieldId == null) {
            ...
            String result = moocOrder2018TMapper.getSoldSeatsByFieldId(fieldId);
            return result;
        }
    }
